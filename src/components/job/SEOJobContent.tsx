...
export function SEOJobContent({ jobData }: SEOJobContentProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-blue-50 mt-12 p-8 rounded-2xl">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900">İş Nasıl Aranır?</h3>
            </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900">CV Nasıl Hazırlanır?</h3>
            </div>
            <p className="text-gray-700 mb-4">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Kariyer Gelişimi</h3>
            </div>
            <p className="text-gray-700 mb-4">
              ...
              <div key={index} className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <ul className="space-y-1">
                  {item.jobs.map((job, jobIndex) => (
                    <li key={jobIndex} className="text-sm text-gray-600 hover:text-blue-600 cursor-pointer transition-colors">
                      • {job} İş İlanları
                    </li>
                  ))}
                </ul>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              ...
              <div key={index} className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:border-blue-200 transition-colors">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h4 className="font-semibold text-gray-900 mb-2">{workType.type}</h4>
                <p className="text-sm text-gray-600 mb-4">{workType.description}</p>
                <ul className="space-y-1">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h4 className="font-semibold text-gray-900 mb-3">İş İlanı Başvuru Süreci</h4>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h4 className="font-semibold text-gray-900 mb-3">Mülakat Hazırlığı</h4>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h4 className="font-semibold text-gray-900 mb-3">Kariyer Planlama</h4>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h4 className="font-semibold text-gray-900 mb-3">Dijital Varlık Yönetimi</h4>
                <p className="text-sm text-gray-700 mb-4">
        ...
        <section className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">Günlük Yeni İlan</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-green-600 mb-2">81</div>
              <div className="text-sm text-gray-600">İl Genelinde Fırsat</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-600 mb-2">20+</div>
              <div className="text-sm text-gray-600">Farklı Sektör</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-600 mb-2">7/24</div>
              <div className="text-sm text-gray-600">Güncel İlan Akışı</div>
            </div>
          </div>

          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div>
              <h4 className="font-semibold text-gray-900 mb-3">En Çok Aranan Pozisyonlar</h4>
            ...
            <div>
              <h4 className="font-semibold text-gray-900 mb-3">Yükselen Sektörler</h4>
              <ul className="space-y-1 text-sm text-gray-600">
            ...
            <div>
              <h4 className="font-semibold text-gray-900 mb-3">Gelecek Becerileri</h4>
              <ul className="space-y-1 text-sm text-gray-600">
        ...
        <section className="text-center bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-xl">
          <h3 className="text-2xl font-bold mb-4">Hayalinizdeki İşe Bugün Başlayın!</h3>
        ...
        <section className="text-center text-sm text-gray-600 leading-relaxed">
          <p className="mb-4">
